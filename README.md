...
- A paired handheld path through the sibling `asteria-ds` repo, which turns an old 3DS into a lightweight robot controller and prompt terminal.
...
Live VEX AIM control needs external local dependencies, usually checked out beside this repo:
...
Use this repo with the sibling handheld client:
